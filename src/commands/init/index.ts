...
function masterKeyGuidance(): string {
	return [
		...
		"",
		"Quickest route — run it from an interactive terminal and it asks for",
		"admin access itself:",
		"",
		'  am agent create --name "…" --slug "…"',
		"",
		"The first time, a code goes to the org owner's email to enrol this",
		"machine; after that it asks for your login password.",
		"",
